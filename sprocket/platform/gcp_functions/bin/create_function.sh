...
SPROCKET_FILES=(sprocket/__init__.py sprocket/controlling/__init__.py sprocket/controlling/common/handler_sockets.py sprocket/controlling/worker/__init__.py sprocket/controlling/worker/fd_wrapper.py sprocket/controlling/worker/worker.py sprocket/controlling/common/__init__.py sprocket/controlling/common/network.py sprocket/controlling/common/handler.py sprocket/controlling/common/defs.py sprocket/controlling/common/socket_nb.py)
